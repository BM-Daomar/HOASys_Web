                    ...
                    <div style="margin: 0 20px">
                        ...
                        <div class="col-xl-6 pt-4">
                                <div class="form-group">
                                    <label for="recipient-name" class="m--font-bolder">Monthly Payment<span
                                            class="m--font-danger">*</span></label>
                                    <input step="0.1" type="number" class="form-control m-input m-input--solid" id="monthly_payment_up"
                                        autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-xl-6 pt-4">
                                <div class="form-group">
                                    <label for="recipient-name" class="m--font-bolder">Due Date is every (1st, 2nd, 3rd) of the month <span
                                            class="m--font-danger">*</span></label>
                                    <input placeholder="Type Either 1-31 day..." type="number" class="form-control m-input m-input--solid" id="due_date_payment_up"
                                        autocomplete="off" required>
                                </div>
                            </div>
                        </div>
