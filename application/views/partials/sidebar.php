...
/* Change text color */
.m-menu__link-text {
    color: #073a4b !important; /* Change this to the desired text color */
}

/* Change hover color */
.m-menu__link:hover {
    background-color: yellow !important; /* Change this to the desired hover background color */
}
...
.m-menu__item--selected a {
    background: black !important; /* Change to your desired color */
}
.m-menu__item--active a {
    background: #073a4b !important; /* Change to your desired background color for active state */
    color: pink !important; /* Change to your desired text color for active state */
}

/* Hover state */
.m-menu__item:hover a {
    background: #f0f0f0 !important; /* Change to your desired background color for hover state */
    color: pink !important; /* Change to your desired text color for hover state */
}
.m-menu__link {
...
<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-light sidebarDark"
    ...
    <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-light m-aside-menu--submenu-skin-light "
        ...
        <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow" id="side_menu">
            ...
            <li class="m-menu__item <?= (current_url() === base_url('payment')) ? 'm-menu__item--active' : '' ?>">
                <a href="<?= base_url('payment') ?>" class="m-menu__link">
                    <i class="m-menu__link-icon la la-money"></i>
                    <span class="m-menu__link-text">Dues</span>
                </a>
            </li>
            <!-- <li id="payment_Menu" style="" class="m-menu__item <?= (current_url() === base_url('homeowners')) ? 'm-menu__item--active' : '' ?>">
                    <a href="<?= base_url('homeowners') ?>" class="m-menu__link">
                        <i class="m-menu__link-icon la la-money "></i>
                        <span class="m-menu__link-text">Payment</span>
                    </a>
                </li> -->
        </ul>
    </div>
